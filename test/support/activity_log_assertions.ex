defmodule PhoenixKitDashboards.ActivityLogAssertions do
  @moduledoc """
  Helpers for asserting activity log entries landed with the right action, actor,
  and metadata shape.

  Imported into `PhoenixKitDashboards.DataCase` and `PhoenixKitDashboards.LiveCase`
  ...
  criteria. Returns the matched row.
